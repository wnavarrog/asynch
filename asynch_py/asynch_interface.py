...
ASYNCH_LIBRARY_LOCATION = './libs/libasynch_py.so'
...
ASYNCH_DB_LOC_RSV = 3
ASYNCH_DB_LOC_HYDROSAVE = 4
ASYNCH_DB_LOC_PEAKSAVE = 5
ASYNCH_DB_LOC_HYDRO_OUTPUT = 6
ASYNCH_DB_LOC_PEAK_OUTPUT = 7
ASYNCH_DB_LOC_SNAPSHOT_OUTPUT = 8
ASYNCH_DB_LOC_FORCING_START = 9
...
class IVEC(Structure):
	_fields_ = [("ve",POINTER(c_int)),("dim",c_uint)]
...
ASYNCH_F_DATATYPE = CFUNCTYPE(None,c_double,POINTER(VEC),POINTER(POINTER(VEC)),c_ushort,POINTER(VEC),POINTER(c_double),POINTER(QVSData),POINTER(VEC),POINTER(IVEC),c_int,POINTER(POINTER(c_uint)),POINTER(c_uint),POINTER(VEC))
...
ASYNCH_ALG_DATATYPE = CFUNCTYPE(None,POINTER(VEC),POINTER(VEC),POINTER(VEC),POINTER(QVSData),c_int,POINTER(VEC))
ASYNCH_STATECHECK_DATATYPE = CFUNCTYPE(c_int,POINTER(VEC),POINTER(VEC),POINTER(VEC),POINTER(QVSData),c_uint)

ASYNCH_OUTPUT_DATATYPE = CFUNCTYPE(None,c_double,POINTER(VEC),POINTER(VEC),POINTER(VEC),POINTER(IVEC),c_int,c_void_p)
ASYNCH_OUTPUT_INT_DATATYPE = CFUNCTYPE(c_int,c_double,POINTER(VEC),POINTER(VEC),POINTER(VEC),POINTER(IVEC),c_int,c_void_p)
ASYNCH_OUTPUT_DOUBLE_DATATYPE = CFUNCTYPE(c_double,c_double,POINTER(VEC),POINTER(VEC),POINTER(VEC),POINTER(IVEC),c_int,c_void_p)
...
class UnivVars(Structure):
	_fields_ = [("type",c_ushort),("method",c_ushort),("max_s",c_ushort),("max_parents",c_ushort),
			...
			("dim",c_uint),("problem_dim",c_uint),("discont_size",c_uint),("max_localorder",c_uint),
			("diff_start",c_uint),("no_ini_start",c_uint),("uses_dam",c_ushort),("global_params",POINTER(VEC)),
			("params_size",c_uint),("iparams_size",c_uint),("dam_params_size",c_uint),("disk_params",c_uint),
			...
			("outletlink",c_uint),("num_dense",c_uint),("dense_indices",POINTER(c_uint)),("string_size",c_uint),
			("query_size",c_uint),("assim_flag",c_ushort),("convertarea_flag",c_ushort),("discont_tol",c_double),
			("template_flag",c_ushort),("num_forcings",c_uint),("hydros_loc_flag",c_ushort),("peaks_loc_flag",c_ushort),
			...
			("num_print",c_uint),("print_indices",POINTER(c_uint)),
			("outputs_d",POINTER(CFUNCTYPE(c_double,c_double,POINTER(VEC),POINTER(VEC),POINTER(VEC),POINTER(IVEC),c_int,c_void_p))),
			("outputs_i",POINTER(CFUNCTYPE(c_int,c_double,POINTER(VEC),POINTER(VEC),POINTER(VEC),POINTER(IVEC),c_int,c_void_p))),
			("output_names",POINTER(c_char_p)),("output_specifiers",POINTER(c_char_p)),("output_types",POINTER(c_ushort)),("output_sizes",POINTER(c_ushort)),
...
class Link(Structure):
	_fields_ = [("method",POINTER(RKMethod)),("list",POINTER(RKSolutionList)),("errorinfo",POINTER(ErrorData)),("params",POINTER(VEC)),
			...
			("upstream",POINTER(POINTER(c_uint))),("numupstream",POINTER(c_uint)),("qvs",POINTER(QVSData)),("pos_offset",c_long),
			("expected_file_vals",c_uint),("dam",c_ushort),("res",c_ushort),("forcing_buff",POINTER(POINTER(ForcingData))),
			("forcing_change_times",POINTER(c_double)),("forcing_values",POINTER(c_double)),("forcing_indices",POINTER(c_uint)),
			("output_user",c_void_p),("peakoutput_user",c_void_p),("last_eta",c_double),
...
ASYNCH_PRECALCULATIONS_DATATYPE = CFUNCTYPE(None,POINTER(Link),POINTER(VEC),POINTER(VEC),POINTER(IVEC),c_uint,c_uint,c_ushort,c_uint,c_void_p)
ASYNCH_INITIALIZEEQS_DATATYPE = CFUNCTYPE(c_uint,POINTER(VEC),POINTER(VEC),POINTER(IVEC),POINTER(QVSData),c_ushort,POINTER(VEC),c_uint,c_uint,c_uint,c_void_p)
...
class asynchsolver:
	def __init__(self):
		...
		self.lib.Asynch_Load_System.restype = None
	...
	def Load_System(self):
		self.lib.Asynch_Load_System(self.asynch_obj)
