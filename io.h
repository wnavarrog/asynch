...
#define ASYNCH_DB_LOC_RSV 3
#define ASYNCH_DB_LOC_HYDROSAVE 4
#define ASYNCH_DB_LOC_PEAKSAVE 5
#define ASYNCH_DB_LOC_HYDRO_OUTPUT 6
#define ASYNCH_DB_LOC_PEAK_OUTPUT 7
#define ASYNCH_DB_LOC_SNAPSHOT_OUTPUT 8
#define ASYNCH_DB_LOC_FORCING_START 9
