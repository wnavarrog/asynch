...
def Precalculations_MyModel(link_i,global_params,params,iparams,disk_params,params_size,dam,model_type,lib_ptr):
...
def ReadInitData_MyModel(global_params,params,iparams,qvs,dam,y_0,model_type,diff_start,no_ini_start,lib_ptr):
...
@ASYNCH_F_DATATYPE
def LinearHillslope_MyModel(t,y_i_ptr,y_p,numparents,global_params_ptr,forcing_values,qvs_ptr,params_ptr,iparams_ptr,state,upstream,numupstream,ans_ptr):
...
@ASYNCH_F_DATATYPE
def LinearHillslope_Reservoirs_MyModel(t,y_i_ptr,y_p_ptr,numparents,global_params_ptr,forcing_values_ptr,qvs_ptr,params_ptr,iparams_ptr,state,upstream,numupstream,ans_ptr):
	ans = ans_ptr.contents.ve
...
if my_rank == 0:	print 'Loading system...'
asynch.Load_System()
